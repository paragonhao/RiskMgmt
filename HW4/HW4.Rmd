...
In the previous HW3, Is obtained 8 exceptions using historical and exponential weighting on normalized return. I would say that pareto distribution is as a good technique to estimate the VaR as the techniques we used in HW3.
